                ...
                <div class="card">
                  <div class="table-responsive">
                    <table class="table card-table table-vcenter text-nowrap datatable">
                      ...
                      <tbody>
                        <?php
                      $sql=mysqli_query($connect,"SELECT * from pendaftar WHERE status_pendaftar='Diterima'");
                      $no=1;
                      while($h=mysqli_fetch_array($sql)){ ?>
                        <tr>
                          ...
                          <td><?php echo $h['setara_kelas'];?></td>
                          <td>
                          <a href="siswaaktif_tambah.php?id=<?php echo $h['no_pendaftar']?>" class="btn btn-success">Tambah ke Siswa</a>
                          </td>
                        </tr>
                        <?php $no++; } ?>
                      </tbody>
