              ...
              <div class="form-group">
                <label>Waktu</label>
                  <div class="input-group">
                    ...
                    <input name="jammulai" type="time" class="form-control" onkeypress="return isNumber(event)"/>  
                    <span style="margin-left:5px;margin-right:5px;">Sampai</span>
                    <input name="jamselesai" type="time" class="form-control" onkeypress="return isNumber(event)"/>  
                  </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label>Waktu</label>
                  <div class="input-group">
                    ...
                    <input name="jammulai" type="time" class="form-control" value="<?php echo $h['jam_mulai'] ?>" onkeypress="return isNumber(event)"/>  
                    <span style="margin-left:5px;margin-right:5px;">Sampai</span>
                    <input name="jamselesai" type="time" class="form-control" value="<?php echo $h['jam_selesai'] ?>" onkeypress="return isNumber(event)"/>  
                  </div>
              </div>
              <div class="form-group">
                <label>Mata Pelajaran</label>
...
//else{ 
   $input=mysqli_query($connect,"INSERT INTO `jadwal`(`id_jadwal`, `kode_ta`, `semester`, `kode_kelas`, `hari`, `kode_mapel`, `jam_mulai`, `jam_selesai`, `kode_tutor`) VALUES ('','$id_ta','$semester','$id_kelas','$hari','$id_mapel','$jam_mulai','$jam_selesai','$id_tutor')");
     //var_dump($input); exit();
   if ($input){
